...
<h4 class="mb-3 container">Commande id :&nbsp;<?php echo $_GET['edit'];  ?></h4>
...
echo'<form method="POST">
    ...
    echo'                 
                    ...
                    <div class="col-sm-4">
                        <label  class="form-label">Date de laivraison</label>
                        // disabled
                ...
                <div class="col-sm-3">
                <label  class="form-label">Numéro suivant</label>
